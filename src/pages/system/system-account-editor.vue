  ...
  export default {
    ...
    created() {
      if (this.$route.params.accountId !== '0') {
        this.post(1, 'system/getSystemAccountDetail', {accountId: this.$route.params.accountId});
      }
    },
    methods: {
      imgError(e){
            ...
            this.$refs.form.validate(valid => {
              if (valid) {
                ...
                if (this.isEmpty(this.systemAccount.accountId)) {
                  ...
                  this.post(2, 'system/insertSystemAccount', params);
                } else {
                  params.accountId = this.systemAccount.accountId;
                  this.post(2, 'system/updateSystemAccount', params);
                }
              }
            });
            break;
