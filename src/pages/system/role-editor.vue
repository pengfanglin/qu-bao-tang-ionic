  ...
  <div class="role_root">
    ...
    <div v-for="parentModule in allModule" class="role_content">
      <div class="parent theme">
        <label>
        <input type="checkbox" :value="parentModule.moduleId" @change="parentChange(parentModule)" v-model="myModule"/>
      ...
      <div class="child-root">
        <div v-for="childModule in parentModule.systemModules" class="child">
          <label>
          <input type="checkbox"  :value="childModule.moduleId" @change="childChange(parentModule,childModule)" v-model="myModule"/>
  ...
  export default {
    ...
    beforeMount() {
      if(this.$route.params.roleId!=='0'){
        this.post(1, 'system/getRoleDetail', {roleId: this.$route.params.roleId});
      }
      this.post(2, 'system/getSystemModuleTree');
      this.baseData = [
        ...
        switch(index){
          case 0:
            ...
            if (this.isEmpty(this.role.roleId)) {
              this.post(3, 'system/insertRole', this.role);
            } else {
              this.post(4, 'system/updateRole', this.role);
            }
            break;
        }
      },
