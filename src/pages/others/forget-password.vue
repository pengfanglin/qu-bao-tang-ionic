  ...
  <div class="login-root">
    ...
    <div class="content">
      ...
      <div class="form">
        ...
        <my-input type="code" v-model="code" :mobile="member_account" @sendCode="sendCode" code="forget_password"></my-input>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      register() {
        ...
        this.post(1, 'memberInterfaces.api?memberForgetPassword', params);
      }
    }
  }
</script>
